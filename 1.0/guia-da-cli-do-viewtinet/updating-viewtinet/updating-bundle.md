...
2.  **Reinício módulo por módulo** (recomendado para menor tempo de inatividade)<br />
    Use os scripts individuais de módulo descritos no capítulo _[Operating Viewtinet Containers via Scripts](/1.0/guia-da-cli-do-viewtinet/cli-commands-reference/managing-containers/operating-viewtinet-containers-via-scripts)_. Embora isso ainda incorra em breve indisponibilidade por módulo, o impacto total é muito menor que um reinício completo.
